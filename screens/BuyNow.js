...
const BuyNow = () => {
  ...
  const originalPrice = items
    .map((item) => Number(item.op) * suj)
    .reduce((prev, curr) => prev + curr, 0);
  ...
  return (
    ...
    >
      <View style={{ marginVertical: 10, marginLeft: 10,backgroundColor:"white" }}>
          ...
          <>
            ...
            >
              ...
              >
                <Image
                  ...
                  style={{ width: 60, height: 80, marginLeft: 50,resizeMode: "contain" }}
                />
              </View>
            </View>
            <View
            ...
            >
              ...
              >
                <Pressable
                  style={{}}
                  onPress={() => setSuj(Math.max(1, suj - 1))}
                >
                  <Text
                    style={{
                      fontSize: 25,
      ...
      <View style={{ margin: 12 }}>
        ...
        >
          ...
          <Text style={{ color: "#006A4E" }}>FREE</Text>
        </View>
        <View
          style={{
            flexDirection: "row",
      ...
      <Text style={{ height: 1, backgroundColor: "#DADD98" }}></Text>
      <Pressable
